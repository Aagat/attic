...
RUN apk add --no-cache ca-certificates chromium fontconfig font-noto font-noto-cjk ttf-dejavu \
    ...
    && mktexlsr \
    && ln -s /usr/share/texmf-dist/fonts/opentype/public/lm /usr/share/fonts/latin-modern \
    && fc-cache -f \
